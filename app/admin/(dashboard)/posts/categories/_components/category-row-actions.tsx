...
import { deletePostCategory } from '../_actions';
...
export function CategoryRowActions({
  ...
  return (
    <div className="flex items-center gap-1">
      <Link
        href={`/admin/posts/categories/${categoryId}/edit`}
        aria-label="Edit"
        title="Edit"
      ...
      <ConfirmAction
        action={deletePostCategory.bind(null, categoryId)}
        title={`Delete "${categoryName}"?`}
        description="Posts in this category will become uncategorised. They will not be deleted."
